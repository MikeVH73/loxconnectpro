...
export default function VerifyPage() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (link) {
        window.location.href = link; // redirect to Firebase verification link
      } else {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-lg shadow p-6">
        ...
        <p className="text-sm text-gray-600 mb-4">Enter your account email. We’ll generate a verification link.</p>
